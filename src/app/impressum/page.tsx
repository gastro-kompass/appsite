      ...
      <div className="mx-auto max-w-4xl px-6 py-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#F5F5F5] rounded-2xl p-6 space-y-3">
              ...
              <div>
                ...
                <p className="text-[#1A1A1A] font-semibold">1190 Wien, Österreich</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-[#F5F5F5] rounded-2xl p-6">
            <h3 className="font-bold text-[#1A1A1A] mb-2 text-lg">Haftung für Inhalte</h3>
          ...
          <div className="bg-[#F5F5F5] rounded-2xl p-6">
            <h3 className="font-bold text-[#1A1A1A] mb-2 text-lg">Urheberrecht</h3>
            <p className="text-gray-700 leading-relaxed text-sm">
